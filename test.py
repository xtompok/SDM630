...
#        master.set_verbose(True)
	#master.handle_local_echo = True
        ...
        Volts2 = master.execute(slave=SLAVE, function_code=cst.READ_INPUT_REGISTERS, starting_address=0x0024, quantity_of_x=2, data_format='>f')[0]
#	for i in range(0x158/2):
#		try:
#        		Volts3 = master.execute(slave=SLAVE, function_code=cst.READ_INPUT_REGISTERS, starting_address=i*2, quantity_of_x=2, data_format='>f')[0]
#			print Volts3
#		except:
#			print "--"
        ...
        print('Voltage: %.1f Volts' % (Volts2))
        #print('Voltage: %.1f Volts' % (Volts3))
